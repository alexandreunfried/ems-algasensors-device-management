package com.unfried.algasensors.device.management.api.config.web;

import com.unfried.algasensors.device.management.api.client.SensorMonitoringClientBadGatewayException;
